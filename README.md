...
- 취업 스터디에서 코딩 테스트 연습을 자율화 및 루틴화함에 따라 기존에 스터디에서 진행했던 문제풀이 폴더(1주차, 2주차 등)는 모두 [legacy](https://github.com/MiraeNaeil-CTCS/Coding-Test/tree/main/legacy) 폴더로 이동했습니다. 이전 문제 열람하실 분들은 이 점 참고해주시길 바랍니다.
